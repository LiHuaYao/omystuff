    ...
    <div class="slide slides_container"  >
      ...
      <div>
        ...
        <div class="caption conference">
          ...
          <?php }  else {  ?>
          <h2><a href="#"><?php _e( 'Single Click Install Wordpress Theme', 'cloriato-lite'); ?></a></h2>
          <?php } ?>
          ...
          <?php }  else {  ?>
          <p><?php _e( 'Get Your Whole Site ready in an Instant. Just Upload the Theme and Press the Activate Button, Your whole site would be loaded with all the Dummy Content and all.', 'cloriato-lite'); ?></p>
          <?php } ?>
        </div>
      </div>
      <!--End Slider-->
...
<div class="grid_24 home_content_wrapper">
  ...
  <div class="home_content">
    <div class="home_text">
      ...
      <center><h1><?php echo stripslashes(inkthemes_get_option('inkthemes_mainheading')); ?></h1></center>
      <?php } else {  ?>
      <center><h1><?php _e( 'Welcome to Our Site. Set this Heading from Themes Option Panel.', 'cloriato-lite'); ?></h1></center>
      <?php } ?>
      ...
      <?php } else {  ?>
      <center><p>
              <?php _e( 'You can setup almost all the options using the Themes Options Panel. Just fill all the values and your text in the Themes Options Panel Form and just save the changes, the changes would start to reflect on the Home Page of your website. Its really simple and easy to use.', 'cloriato-lite'); ?></p></center>
      <?php } ?>
    </div>
  </div>
  <!--End home content-->
  ...
  <div class="feature_content">
    <div class="two_third feature_box">
      <div class="feature_inner">
        ...
        <?php } else {  ?>
        <h2><a href="#"><?php _e( 'What is this place ?', 'cloriato-lite'); ?></a></h2>
        <?php } ?>   
        ...
        <p><?php _e( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer dictum, neq
          ...
          rmentum diam sagittis ullamcorper.', 'cloriato-lite'); ?></p>        
        <?php } ?>
        <a href="<?php if ( inkthemes_get_option('inkthemes_col_left_readmore') !='' ) { echo inkthemes_get_option('inkthemes_col_left_readmore'); } ?>" class="read_more"><?php _e( 'read more', 'cloriato-lite'); ?></a>
        </div>
    </div>
    <div class="one_third last">
      <div class="feature_inner right">
        ...
        <?php } else {  ?>
        <h2><a href="#"><?php _e( 'Out Latest Project', 'cloriato-lite'); ?></a></h2>
        <?php } ?>   
        ...
        <?php } else { ?>
        <img class="feature_image" src="<?php echo get_template_directory_uri(); ?>/images/featured-image.png"/>
        <?php } ?>
        ...
        <?php } else {  ?>        
        <p><?php _e( 'Theme from InkThemes.com are based on One Click Installation, letting you to create your website at the Click of the button which provides great experience to a customer.', 'cloriato-lite'); ?>
<br/><?php _e( 'Neeraj Agarwal', 'cloriato-lite'); ?>
</p>
        <?php } ?>
<a href="<?php if ( inkthemes_get_option('inkthemes_col_right_readmore') !='' ) { echo inkthemes_get_option('inkthemes_col_right_readmore'); } ?>" class="read_more"><?php _e( 'read more', 'cloriato-lite'); ?></a>
         </div>
    </div> 
  </div>
  <!--End Feature content-->
